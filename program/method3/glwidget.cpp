...
/*		if(i!=1)
		...
		glVertex3f(0,0,0);
		glVertex3f(one.c2_[0].x*1000,one.c2_[0].y*1000,one.c2_[0].z*1000);  //ob
		}
		if(i!=0)
		{glColor3f(0,1,1);   //light green

		glVertex3f(0,0,0);
		glVertex3f(one.c1_[0].x*1000,one.c1_[0].y*1000,one.c1_[0].z*1000);  }

*/
if(i!=1)
       {glColor3f(0,0,1);  //blue
//		glVertex3f(0,0,0);
		glVertex3f(one.c2_[1].x,one.c2_[1].y,one.c2_[1].z);
		glVertex3f(one.c2_[2].x,one.c2_[2].y,one.c2_[2].z);
		glVertex3f(one.c2_[2].x,one.c2_[2].y,one.c2_[2].z);
		glVertex3f(one.c2_[0].x,one.c2_[0].y,one.c2_[0].z);
//}
...
{	glColor3f(1,0,1);
//glVertex3f(0,0,0);   //紫
		glVertex3f(one.c1_[1].x,one.c1_[1].y,one.c1_[1].z);
		glVertex3f(one.c1_[2].x,one.c1_[2].y,one.c1_[2].z);
		glVertex3f(one.c1_[2].x,one.c1_[2].y,one.c1_[2].z);
		glVertex3f(one.c1_[0].x,one.c1_[0].y,one.c1_[0].z);
}
...
{glColor3f(1,0,0);  //red
		...
		glVertex3f(0,0,0);
		glVertex3f(one.c2_[2].x*1000,one.c2_[2].y*1000,one.c2_[2].z*1000);
}
if(i!=0)
{	glColor3f(1,1,0);	
		glVertex3f(0,0,0);
		glVertex3f(one.c1_[2].x*1000,one.c1_[2].y*1000,one.c1_[2].z*1000);}*/
		glEnd();
	}	 
}
