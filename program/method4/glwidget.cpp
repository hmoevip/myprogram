...
//	one.ComputeConvex();
	one.Output("点云在xy平面上投影凸包点逆序：",one.order_xy);
	one.Output("点云在xz平面上投影凸包点逆序：",one.order_xz);
	one.Output("点云在yz平面上投影凸包点逆序：",one.order_yz);
	flag_show = true;
    updateGL();
}
...
//	two.ComputeConvex();
	two.Output("数模在xy平面上投影凸包点逆序：",two.order_xy);
	two.Output("数模在xz平面上投影凸包点逆序：",two.order_xz);
	two.Output("数模在yz平面上投影凸包点逆序：",two.order_yz);
	flag_show = true;
	
/*	cout<<"数模在xy平面："<<endl;
	two.aaaaa(one.order_xy);
	cout<<"数模在xz平面："<<endl;
	two.aaaaa(one.order_xz);
	cout<<"数模在yz平面："<<endl;
	two.aaaaa(one.order_yz);
	cout<<"点云在xy平面："<<endl;
	two.aaaaa(two.order_xy);
	cout<<"点云在xz平面："<<endl;
	two.aaaaa(two.order_xz);
	cout<<"点云在yz平面："<<endl;
	two.aaaaa(two.order_yz);*/
//	one.Compute(two);
    updateGL();
}
...
void GLWidget::MyPaint()
{
	...
	if(flag_show)
	{
		...
		glEnd();
		glBegin(GL_LINES);
//		glVertex3f(-182+0.619104,27909.3-27904.7,4948.86-4966.39);
//		glVertex3f(182+0.619104,27911.9-27904.7,4948.91-4966.39);

//		glVertex3f(-182+0.619104,27909.3-27904.7,4948.86-4966.39);
//		glVertex3f(182+0.619104,27911.9-27904.7,4948.91-4966.39);

		glColor3f(0.0,0.0,1.0);
		glVertex3f(-290.012+130.084, -96.3861-4.51677, 45.8348-4.07442);
		glVertex3f(132.303+130.084, 36.5653-4.51677, -26.6485-4.07442);

//		glVertex3f(0,0,0);
	//		glVertex3f(-182+0.619104,27923-27904.7,4956.16-4966.39);
//		glColor3f(1,0,0);
//		glVertex3f(0,0,0);
	//	glVertex3f(182+0.619104,27860.3-27904.7,4991.95-4966.39);
//		glVertex3f(181.239+0.619104,27857.5-27904.7,4994.6-4966.39);
//		glVertex3f(-155.334+0.619104,27853.1-27904.7,4998.88-4966.39);

//		glVertex3f(-161.126+18.1125,111.696-28.7139,-61.7108-31.7087);
//		glVertex3f(34.831+18.1125,-144.618-28.7139,95.0433-31.7087);
//		glVertex3f(60.7119+18.1125,232.041-28.7139,-165.357-31.7087);
		glColor3f(1,1,0);
		glVertex3f(-134.693+130.084, -204.139-4.51677, 157.76-4.07442);
		glVertex3f(-15.2652+130.084, 124.803-4.51677, -121.973-4.07442);

//		glVertex3f(0,0,0);
//		glVertex3f(-161.126+18.1125,111.696-28.7139,-61.7108-31.7087);
	//	glVertex3f(-160.031+18.1125,115.15-28.7139,-61.4471-31.7087);
//		glColor3f(0,0,1);
//		glVertex3f(0,0,0);
//		glVertex3f(80.9495+18.1125,-95.9458-28.7139,123.585-31.7087);
    //    glVertex3f(91.0369+18.1125,-93.6237-28.7139,114.821-31.7087);

		glColor3f(1,1,0);
		glVertex3f(201.964-0.000268154, 28087.7-28081.3, 5906.02-6098.88);
		glVertex3f(-190.54-0.000268154, 28097.7-28081.3, 6122.28-6098.88);
//		glVertex3f(0,0,0);
//		glVertex3f(-161.126+18.1125,111.696-28.7139,-61.7108-31.7087);
//		glVertex3f(39.5827+18.1125,-143.06-28.7139,98.589-31.7087);
//		glColor3f(0,0,1);
//		glVertex3f(0,0,0);
//		glVertex3f(80.9495+18.1125,-95.9458-28.7139,123.585-31.7087);
//       glVertex3f(-107.155+18.1125,165.096-28.7139,-46.5414-31.7087);
		...
		glVertex3f(190.54-0.000268154, 28097.7-28081.3, 6122.28-6098.88);
//		glVertex3f(182+0.619104,27923-27904.7,4956.16-4966.39);
//		glVertex3f(-181.293+0.619104,27857.5-27904.7,4994.6-4966.39);

//		glVertex3f(39.5827+18.1125,-143.06-28.7139,98.589-31.7087);
//		glVertex3f(-107.155+18.1125,165.096-28.7139,-46.5414-31.7087);
//		glVertex3f(38.5178+18.1125,-143.816-28.7139,97.8422-31.7087);
//		glVertex3f(60.7119+18.1125,232.041-28.7139,-165.357-31.7087);
		glEnd();

				//glPointSize(1.0);
/*		glBegin(GL_LINE_LOOP);
		for(unsigned long i=0; i<two.order_xy.size();i++)
		{
			glVertex3f(two.order_xy.at(i).x,two.order_xy.at(i).y,two.order_xy.at(i).z);
		}
		glEnd();*/
	}	 
}
