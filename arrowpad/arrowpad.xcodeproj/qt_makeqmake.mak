...
QMAKE    = /usr/bin/qmake
arrowpad.xcodeproj/project.pbxproj: arrowpad.pro ../../.qmake.cache /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o arrowpad.xcodeproj/project.pbxproj arrowpad.pro
