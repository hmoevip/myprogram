...
QMAKE    = /usr/bin/qmake
arrowpad.pbproj/project.pbxproj: arrowpad.pro ../../.qmake.cache /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-xcode -o arrowpad.pbproj/project.pbxproj arrowpad.pro
